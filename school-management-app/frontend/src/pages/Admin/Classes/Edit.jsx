  ...
  const handleSubjectToggle = (subjectId) => {
    setSelectedSubjects(prev => {
      ...
      if (newSelected[subjectId]) {
        ...
        newSelected[subjectId] = 2; // Coefficient par défaut à 2
      }
      return newSelected;
    });
  };
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                <Alert severity="info" sx={{ mb: 2 }}>
                  Sélectionnez les matières et définissez leur coefficient (de 1 à 10).
                  Le coefficient détermine l'importance de chaque matière dans la moyenne générale.
                </Alert>
              </Grid>
              ...
              <Grid item xs={12}>
                <Card variant="outlined">
                  <CardContent>
                    {subjects.length === 0 ? (
                      <Alert severity="warning">
                        <Typography variant="body2">
                          Aucune matière n'est disponible. Veuillez d'abord créer des matières dans la section "Matières".
                        </Typography>
                        <Button
                          size="small"
                          variant="outlined"
                        ...
                        {subjects.map((subject) => {
                          ...
                          return (
                            <Grid item xs={12} sm={6} md={4} key={subject.id}>
                              ...
                              >
                                <CardContent sx={{ pb: 2 }}>
                                  <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: isSelected ? 1 : 0 }}>
                                    <Box 
                                      sx={{ 
                                        display: 'flex', 
                                        alignItems: 'center', 
                    ...
                    {Object.keys(selectedSubjects).length === 0 && subjects.length > 0 && (
                      <Alert severity="warning" sx={{ mt: 2 }}>
                        Veuillez sélectionner au moins une matière pour cette classe.
                      </Alert>
                    )}
                ...
                <Card variant="outlined" sx={{ mt: 2 }}>
                  <CardContent>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12}>
                        <Typography variant="body2" color="textSecondary">
                          Matières ({Object.keys(selectedSubjects).length}):
                        </Typography>
